...
<div class="page-main-header">
    <div class="main-header-right row m-0">
        <div class="main-header-left">
            <div class="logo-wrapper"><a href="../dashboard/index.php"><img class="img-fluid" src="../../assets/images/logo/logo.png" alt=""></a></div>
            <div class="dark-logo-wrapper"><a href="../dashboard/index.php"><img class="img-fluid" src="../../assets/images/logo/dark-logo.png" alt=""></a></div>
